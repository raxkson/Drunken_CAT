        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            try{
                ...
                */
                ...
                buff.write(Double.toString(cur_longitude)+" "+Double.toString(cur_latitude)+" "+formatDate+"\n");
                try {
                    if (buff != null )
                        buff.close();
                    if( fw !=null)
                ...
                Toast.makeText(getApplicationContext(), Double.toString(cur_distance), Toast.LENGTH_SHORT).show();
